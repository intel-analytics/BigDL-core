...
void (*QuantizedConvOpSetupConvParameterRT)(QuantizedConvOp* p, LAYOUT layout, size_t channel_out, size_t channel_in, size_t group, size_t kernel_h, size_t kernel_w, \
          size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dialation_h, size_t dialation_w, size_t fusion_mask, CONV_ALGORITHM algo);

void (*QuantizedConvOpInitWeightRT)(QuantizedConvOp* p, float *weight);

void (*QuantizedConvOpExecuteRT)(QuantizedConvOp* p, float *dst, float *data, float *bias, size_t batch_size, size_t channel_in, size_t height_in, size_t width_in);

void (*QuantizedConvOpFreeRT)(QuantizedConvOp* p);

QuantizedFCOp* (*QuantizedFCOpCreateRT)();

void (*QuantizedFCOpSetupFCParameterRT)(QuantizedFCOp* p, LAYOUT layout, size_t channel_out, size_t channel_in, FC_ALGORITHM algo);

void (*QuantizedFCOpInitWeightRT)(QuantizedFCOp* p, float *weight);

void (*QuantizedFCOpExecuteRT)(QuantizedFCOp* p, float* dst, float *data, float *bias, size_t batch_size, size_t channel_in);

void (*QuantizedFCOpFreeRT)(QuantizedFCOp* p);

void (*QuantizedConvKernelDescInitRT)(QuantizedTensorDesc *quantized_tensor, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w);

void (*QuantizedConvKernelInitRT)(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w, float threshold, LAYOUT layout);

void (*QuantizedConvKernelLoadFromModelRT)(QuantizedTensorDesc *quantized_tensor, int8_t *src, float *min, float* max, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w, float threshold, LAYOUT layout);

void (*QuantizedConvDataDescInitRT)(QuantizedTensorDesc *quantized_tensor, size_t c_in, size_t kernel_h, size_t kernel_w, size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dilation_h, size_t dilation_w, size_t batch_size, size_t h_in, size_t w_in);

void (*QuantizedConvDataInitRT)(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_in, size_t kernel_h, size_t kernel_w, size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dilation_h, size_t dilation_w, size_t batch_size, size_t h_in, size_t w_in, float threshold, LAYOUT layout);
...
void (*QuantizedFCKernelInitRT)(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_out, size_t c_in, float threshold, LAYOUT layout);

void (*QuantizedFCKernelLoadFromModelRT)(QuantizedTensorDesc *quantized_tensor, int8_t *src, float *min, float* max, size_t c_out, size_t c_in, float threshold, LAYOUT layout);

void (*QuantizedFCDataDescInitRT)(QuantizedTensorDesc *quantized_tensor, size_t batch_size, size_t channel);

void (*QuantizedFCDataInitRT)(QuantizedTensorDesc *quantized_tensor, float *src, size_t batch_size, size_t channel, float threshold, LAYOUT layout);
...
void QuantizedConvOpSetupConvParameter(QuantizedConvOp* p, LAYOUT layout, size_t channel_out, size_t channel_in, size_t group, size_t kernel_h, size_t kernel_w, \
          size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dialation_h, size_t dialation_w, size_t fusion_mask, CONV_ALGORITHM algo) {
  QuantizedConvOpSetupConvParameterRT(p, layout, channel_out, channel_in, group, kernel_h, kernel_w, \
          stride_h, stride_w, pad_h, pad_w, dialation_h, dialation_w, fusion_mask, algo);
}
...
void QuantizedConvOpExecute(QuantizedConvOp* p, float *dst, float *data, float *bias, size_t batch_size, size_t channel_in, size_t height_in, size_t width_in) {
...
void QuantizedFCOpSetupFCParameter(QuantizedFCOp* p, LAYOUT layout, size_t channel_out, size_t channel_in, FC_ALGORITHM algo) {
...
void QuantizedFCOpExecute(QuantizedFCOp* p, float* dst, float *data, float *bias, size_t batch_size, size_t channel_in) {
...
void QuantizedConvKernelDescInit(QuantizedTensorDesc *quantized_tensor, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w) {
  QuantizedConvKernelDescInitRT(quantized_tensor, c_out, c_in, kernel_h, kernel_w);
}

void QuantizedConvKernelInit(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w, float threshold, LAYOUT layout) {
  QuantizedConvKernelInitRT(quantized_tensor, src, c_out, c_in, kernel_h, kernel_w, threshold, layout);
}

void QuantizedConvKernelLoadFromModel(QuantizedTensorDesc *quantized_tensor, int8_t *src, float *min, float* max, size_t c_out, size_t c_in, size_t kernel_h, size_t kernel_w, float threshold, LAYOUT layout) {
  QuantizedConvKernelLoadFromModelRT(quantized_tensor, src, min, max, c_out, c_in, kernel_h, kernel_w, threshold, layout);
}

void QuantizedConvDataDescInit(QuantizedTensorDesc *quantized_tensor, size_t c_in, size_t kernel_h, size_t kernel_w, size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dilation_h, size_t dilation_w, size_t batch_size, size_t h_in, size_t w_in) {
  QuantizedConvDataDescInitRT(quantized_tensor, c_in, kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w, dilation_h, dilation_w, batch_size, h_in, w_in);
}

void QuantizedConvDataInit(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_in, size_t kernel_h, size_t kernel_w, size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w, size_t dilation_h, size_t dilation_w, size_t batch_size, size_t h_in, size_t w_in, float threshold, LAYOUT layout) {
  QuantizedConvDataInitRT(quantized_tensor, src, c_in, kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w, dilation_h, dilation_w, batch_size, h_in, w_in, threshold, layout);
}
...
void MixPrecisionGEMM(LAYOUT layout, int8_t* pa, uint8_t* pb, float* pc, size_t m, size_t n, size_t k,
  float* ratio_a, float* ratio_b, float* kernel_sum, float* min_b, float* bias,
  size_t batch_size, size_t channel_per_group, size_t height_out, size_t width_out,
  float fault_tolerance, size_t pad_m, size_t pad_n) {
  MixPrecisionGEMMRT(layout, pa, pb, pc, m, n, k,
...
void QuantizedFCKernelInit(QuantizedTensorDesc *quantized_tensor, float *src, size_t c_out, size_t c_in, float threshold, LAYOUT layout) {
  QuantizedFCKernelInitRT(quantized_tensor, src, c_out, c_in, threshold, layout);
}

void QuantizedFCKernelLoadFromModel(QuantizedTensorDesc *quantized_tensor, int8_t *src, float *min, float* max, size_t c_out, size_t c_in, float threshold, LAYOUT layout) {
...
void QuantizedFCDataInit(QuantizedTensorDesc *quantized_tensor, float *src, size_t batch_size, size_t channel, float threshold, LAYOUT layout) {
