...
struct QuantizedTensor : public Tensor<DstType> {
  ...
  // Because quantizedtensor may be used for computation and pad and alignment, this may cause real shape is different from ori_shape
  Shape ori_shape_;

  QuantizedTensor(Shape quantized_shape, Shape meta_shape, size_t alignment) : Tensor<DstType>(quantized_shape, alignment),
  ...
  QuantizedTensor(Shape quantized_shape, Shape meta_shape, Shape ori_shape, size_t alignment) : Tensor<DstType>(quantized_shape, alignment),
  ...
  QuantizedTensor(Shape quantized_shape, Shape meta_shape, Shape ori_shape) : Tensor<DstType>(quantized_shape),
    ori_shape_(ori_shape),
    min_(meta_shape),
    max_(meta_shape),
    ratio_(meta_shape) {
