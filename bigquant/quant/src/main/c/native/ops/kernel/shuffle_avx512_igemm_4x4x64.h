...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE KernelReduce(int8_t* &pa, uint8_t* &pb,
  SIMDSITYPE &c00, SIMDSITYPE &c01, SIMDSITYPE &c02, SIMDSITYPE &c03,
  ...
  SIMDSITYPE &sum00, SIMDSITYPE &sum01,
  SIMDSITYPE &sum10, SIMDSITYPE &sum11,
  SIMDSITYPE &sum20, SIMDSITYPE &sum21,
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE AVX512Kernel4x4x64(int8_t* &pa, uint8_t* &pb,
  SIMDSITYPE &c00, SIMDSITYPE &c01, SIMDSITYPE &c02, SIMDSITYPE &c03,
  SIMDSITYPE &c10, SIMDSITYPE &c11, SIMDSITYPE &c12, SIMDSITYPE &c13,
  SIMDSITYPE &c20, SIMDSITYPE &c21, SIMDSITYPE &c22, SIMDSITYPE &c23,
  SIMDSITYPE &c30, SIMDSITYPE &c31, SIMDSITYPE &c32, SIMDSITYPE &c33) {
  ...
  c00 = ADDS_EPI16(c00, MADD_EPI8(b0, a0)); c01 = ADDS_EPI16(c01, MADD_EPI8(b1, a0)); c02 = ADDS_EPI16(c02, MADD_EPI8(b2, a0)); c03 = ADDS_EPI16(c03, MADD_EPI8(b3, a0));
  c10 = ADDS_EPI16(c10, MADD_EPI8(b0, a1)); c11 = ADDS_EPI16(c11, MADD_EPI8(b1, a1)); c12 = ADDS_EPI16(c12, MADD_EPI8(b2, a1)); c13 = ADDS_EPI16(c13, MADD_EPI8(b3, a1));
  c20 = ADDS_EPI16(c20, MADD_EPI8(b0, a2)); c21 = ADDS_EPI16(c21, MADD_EPI8(b1, a2)); c22 = ADDS_EPI16(c22, MADD_EPI8(b2, a2)); c23 = ADDS_EPI16(c23, MADD_EPI8(b3, a2));
  c30 = ADDS_EPI16(c30, MADD_EPI8(b0, a3)); c31 = ADDS_EPI16(c31, MADD_EPI8(b1, a3)); c32 = ADDS_EPI16(c32, MADD_EPI8(b2, a3)); c33 = ADDS_EPI16(c33, MADD_EPI8(b3, a3));
  */
  SIMDSITYPE b0 = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pb));
  SIMDSITYPE b1 = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pb + kernel_k));
  SIMDSITYPE b2 = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pb + 2 * kernel_k));
  ...
  c00 = ADDS_EPI16(c00, MADD_EPI8(b0, a)); c01 = ADDS_EPI16(c01, MADD_EPI8(b1, a)); c02 = ADDS_EPI16(c02, MADD_EPI8(b2, a)); c03 = ADDS_EPI16(c03, MADD_EPI8(b3, a));
  a = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pa + kernel_k));
  c10 = ADDS_EPI16(c10, MADD_EPI8(b0, a)); c11 = ADDS_EPI16(c11, MADD_EPI8(b1, a)); c12 = ADDS_EPI16(c12, MADD_EPI8(b2, a)); c13 = ADDS_EPI16(c13, MADD_EPI8(b3, a));
  a = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pa + 2 * kernel_k));
  c20 = ADDS_EPI16(c20, MADD_EPI8(b0, a)); c21 = ADDS_EPI16(c21, MADD_EPI8(b1, a)); c22 = ADDS_EPI16(c22, MADD_EPI8(b2, a)); c23 = ADDS_EPI16(c23, MADD_EPI8(b3, a));
  a = LOAD_SI(reinterpret_cast<SIMDSITYPE*>(pa + 3 * kernel_k));
  c30 = ADDS_EPI16(c30, MADD_EPI8(b0, a)); c31 = ADDS_EPI16(c31, MADD_EPI8(b1, a)); c32 = ADDS_EPI16(c32, MADD_EPI8(b2, a)); c33 = ADDS_EPI16(c33, MADD_EPI8(b3, a));
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE Reduce(SIMDSITYPE &c00, SIMDSITYPE &c01, SIMDSITYPE &c02, SIMDSITYPE &c03,
  ...
  c00 = MADD_EPI16(c00, ones); c01 = MADD_EPI16(c01, ones); c02 = MADD_EPI16(c02, ones); c03 = MADD_EPI16(c03, ones);
  c10 = MADD_EPI16(c10, ones); c11 = MADD_EPI16(c11, ones); c12 = MADD_EPI16(c12, ones); c13 = MADD_EPI16(c13, ones);
  c20 = MADD_EPI16(c20, ones); c21 = MADD_EPI16(c21, ones); c22 = MADD_EPI16(c22, ones); c23 = MADD_EPI16(c23, ones);
  c30 = MADD_EPI16(c30, ones); c31 = MADD_EPI16(c31, ones); c32 = MADD_EPI16(c32, ones); c33 = MADD_EPI16(c33, ones);
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE PostReduce(SIMDSITYPE &accumulator,
                                                         SIMDSITYPE &sum00, SIMDSITYPE &sum01,
                                                         SIMDSITYPE &sum10, SIMDSITYPE &sum11,
                                                         SIMDSITYPE &sum20, SIMDSITYPE &sum21,
                                                         SIMDSITYPE &sum30, SIMDSITYPE &sum31) {
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE ApplyKernel(int8_t* &pa, uint8_t* &pb, size_t k, float fault_tolerance, void* result[], size_t length, size_t valid_lanes,
  ...
  INIT(c00); INIT(c01); INIT(c02); INIT(c03);
  INIT(c10); INIT(c11); INIT(c12); INIT(c13);
  INIT(c20); INIT(c21); INIT(c22); INIT(c23);
  INIT(c30); INIT(c31); INIT(c32); INIT(c33);
  INIT(sum00); INIT(sum01);
  INIT(sum10); INIT(sum11);
  INIT(sum20); INIT(sum21);
  INIT(sum30); INIT(sum31);
  ...
  reduce(c00, c01, c02, c03,
          ...
          sum20, sum21,
          sum30, sum31);
  postprocess(sum00, sum01,
              sum10, sum11,
              sum20, sum21,
              sum30, sum31,
              result, length, valid_lanes);
}
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE ApplyKernel(int8_t* &pa, uint8_t* &pb, size_t k, float fault_tolerance, float* result[], size_t length, size_t valid_lanes,
  ...
  reduce(c00, c01, c02, c03,
          ...
          sum20, sum21,
          sum30, sum31);
  postprocess(sum00, sum01, sum10, sum11, sum20, sum21, sum30, sum31,
              result, length, valid_lanes, i_index, j_index, ratio_a, ratio_b, min_b, kernel_sum, bias,
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE CommitResult(SIMDSITYPE &sum00, SIMDSITYPE &sum01,
                                                           SIMDSITYPE &sum10, SIMDSITYPE &sum11,
                                                           SIMDSITYPE &sum20, SIMDSITYPE &sum21,
                                                           SIMDSITYPE &sum30, SIMDSITYPE &sum31,
  ...
  SIMDSITYPE accumulator = SET_EPI32(MASK_REDUCEADD_EPI32(high_mask, sum31),
                          MASK_REDUCEADD_EPI32(low_mask, sum31),
                          MASK_REDUCEADD_EPI32(high_mask, sum30),
                          MASK_REDUCEADD_EPI32(low_mask, sum30),
                          MASK_REDUCEADD_EPI32(high_mask, sum21),
                          MASK_REDUCEADD_EPI32(low_mask, sum21),
                          MASK_REDUCEADD_EPI32(high_mask, sum20),
                          MASK_REDUCEADD_EPI32(low_mask, sum20),
                          MASK_REDUCEADD_EPI32(high_mask, sum11),
                          MASK_REDUCEADD_EPI32(low_mask, sum11),
                          MASK_REDUCEADD_EPI32(high_mask, sum10),
                          MASK_REDUCEADD_EPI32(low_mask, sum10),
                          MASK_REDUCEADD_EPI32(high_mask, sum01),
                          MASK_REDUCEADD_EPI32(low_mask, sum01),
                          MASK_REDUCEADD_EPI32(high_mask, sum00),
                          MASK_REDUCEADD_EPI32(low_mask, sum00));
...
template<size_t kernel_m, size_t kernel_n>
static INLINE_SPECIFIER void INLINE_ATTRIBUTE FMAResult(SIMDSITYPE &sum00, SIMDSITYPE &sum01,
                                                        SIMDSITYPE &sum10, SIMDSITYPE &sum11,
                                                        SIMDSITYPE &sum20, SIMDSITYPE &sum21,
                                                        SIMDSITYPE &sum30, SIMDSITYPE &sum31,
  ...
  for (size_t m = 0; m < length; ++m) {
    for (size_t n = 0; n < valid_lanes; ++n) {
      *(reinterpret_cast<float*>(result[m * kernel_n + n])) = ratio_a[i_index + m] * ratio_b[j_index + n] * tmp[m * kernel_n + n] + kernel_sum[i_index + m] * min_b[j_index + n] + ((bias == NULL)? 0.0f : bias[i_index]);
      /*
      std::cerr << ratio_a[i_index + m] << " " << ratio_b[j_index + n] << " " << tmp[m * kernel_n + n] << " " << kernel_sum[i_index + m] << " " << min_b[j_index + n] << std::endl;
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE ApplyKernelWrapper(int8_t* &pa, uint8_t* &pb, size_t k, float fault_tolerance, void* result[], size_t length, size_t valid_lanes) {
  ...
  ApplyKernel<kernel_k>(pa, pb, k, fault_tolerance, result, length, valid_lanes, AVX512Kernel4x4x64<kernel_m, kernel_n, kernel_k>, Reduce, CommitResult<kernel_m, kernel_n>);
}
...
static INLINE_SPECIFIER void INLINE_ATTRIBUTE ApplyKernelWrapper(int8_t* &pa, uint8_t* &pb, size_t k, float fault_tolerance, float* result[], size_t length, size_t valid_lanes,
  ...
  assert((kernel_m == 4) && (kernel_n == 4) && (kernel_k == 64));
  if (layout == NCHW) {
    ApplyKernel<kernel_k>(pa, pb, k, fault_tolerance, result, length, valid_lanes, i_index, j_index, ratio_a, ratio_b, min_b, kernel_sum, bias, conv_relu_fusion, conv_bn_fusion, conv_bn_relu_fusion, conv_relu_bn_fusion, global_mean, mul_variance_coeff, scale, shift, AVX512Kernel4x4x64<kernel_m, kernel_n, kernel_k>, Reduce, FMAResult<kernel_m, kernel_n>);
  } else {
    ApplyKernel<kernel_k>(pa, pb, k, fault_tolerance, result, length, valid_lanes, i_index, j_index, ratio_a, ratio_b, min_b, kernel_sum, bias, conv_relu_fusion, conv_bn_fusion, conv_bn_relu_fusion, conv_relu_bn_fusion, global_mean, mul_variance_coeff, scale, shift, AVX512Kernel4x4x64<kernel_m, kernel_n, kernel_k>, Reduce, FMAResult<kernel_m, kernel_n>);
  }
}
