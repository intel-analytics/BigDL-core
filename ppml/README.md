...
javah -cp ppml-java-x86_64-linux/target/ppml-java-x86_64-linux-2.1.0.jar com.intel.analytics.bigdl.ppml.dcap.Attestation
...
```bash
mvn clean package
jar -tf ppml-java-x86_64-linux/target/ppml-java-x86_64-linux-2.1.0.jar | grep libquote_verification.so
```
